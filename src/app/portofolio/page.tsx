...
const projects = [
  { title: 'Green Bin® kathy ireland®', image: '/image/1.png', link: 'https://www.greenbinlicensing.com/' },
  { title: 'ireland pay®', image: '/image/2.png', link: 'https://irelandpay.com/' },
  { title: 'kathy ireland® Furniture Factory', image: '/image/3.png', link: 'http://www.ocfurniturefactory.com/' },
  { title: 'kathy ireland® Laundry', image: '/image/4.png', link: 'https://www.kathyirelandlaundry.info/' },
  { title: 'kathy ireland® Logistics', image: '/image/5.jpeg' },
  { title: 'DUCTS Air Duct Cleaning, Inc™', image: '/image/6.png' },
  { title: 'Dude, I Need A Truck', image: '/image/7.png', link: 'https://www.dudeineedatruck.com/' },
    ...
    <section className="relative mt-12 bg-white py-28 px-6 max-w-7xl mx-auto overflow-hidden">
      ...
      <div className="grid gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 relative z-10">
        {projects.map((item, index) => {
          ...
          return item.link ? (
            <a key={index} href={item.link.trim()} target="_blank" rel="noopener noreferrer" className="block">
              {content}
            </a>
          ) : (
